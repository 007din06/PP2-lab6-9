...
#IMAGES
player_img = pygame.image.load('lab 9/racer2/images/player.png')
enemy_img = pygame.image.load('lab 9/racer2/images/enemy.png')
coin_img = pygame.image.load('lab 9/racer2/images/coin1.png')
background = pygame.image.load('lab 9/racer2/images/street.png')

#Sounds
accident_sound = pygame.mixer.Sound('lab 9/racer2/sounds/accident.wav')
coin_sound = pygame.mixer.Sound('lab 9/racer2/sounds/coin.wav')
music = pygame.mixer.Sound('lab 9/racer2/sounds/music.ogg')
music.play(-1)
