...
#IMAGES
player_img = pygame.image.load('lab 8/player.png')
enemy_img = pygame.image.load('lab 8/enemy.png')
coin_img = pygame.image.load('lab 8/coin.png')
background = pygame.image.load('lab 8/street.png')

#Sounds
accident_sound = pygame.mixer.Sound("lab 8/accident.wav")
coin_sound = pygame.mixer.Sound("lab 8/coin.wav")
music = pygame.mixer.Sound("lab 8/music.ogg")
music.play(-1)
